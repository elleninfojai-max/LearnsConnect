...
-- This migration creates the courses table for tutors to manage their courses
...
-- 7. Sample data will be inserted by the application when tutors create courses
-- No sample data needed here as it would cause foreign key constraint violations
