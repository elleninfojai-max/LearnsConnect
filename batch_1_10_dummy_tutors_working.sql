-- Batch 1: First 10 Complete Dummy Tutor Profiles (WORKING VERSION)
-- This script uses a different approach - we'll insert into tutor_profiles first, then profiles
