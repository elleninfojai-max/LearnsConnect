-- Batch 1: First 10 Complete Dummy Tutor Profiles (FINAL VERSION)
-- This script temporarily disables foreign key constraints to insert dummy data
...
-- Step 3: Insert into tutor_profiles table
