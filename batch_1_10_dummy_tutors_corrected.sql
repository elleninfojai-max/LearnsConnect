-- Batch 1: First 10 Complete Dummy Tutor Profiles (CORRECTED CLASS_TYPE)
-- This script uses the correct capitalized class_type values: 'Individual', 'Group', 'Both'
-- Copy and paste this entire script into Supabase SQL editor

-- Step 1: Insert into tutor_profiles table first (no foreign key constraint)
...
('b1111111-1111-1111-1111-111111111111', 'Dr. Priya Sharma', 'Experienced Mathematics professor with 15+ years of teaching experience. Specialized in Calculus, Algebra, and Statistics. PhD in Mathematics from IIT Delhi.', 
 ...
 '["Higher Secondary", "Graduate", "Professional"]'::jsonb, '["CBSE", "ICSE", "IB"]'::jsonb, 'Individual', 0, 1,
...
('b2222222-2222-2222-2222-222222222222', 'Prof. Rajesh Kumar', 'Physics expert with 12 years of experience. Specialized in Mechanics, Thermodynamics, and Quantum Physics. M.Sc Physics from Delhi University.', 
 ...
 '["Secondary", "Higher Secondary", "Graduate"]'::jsonb, '["CBSE", "ICSE", "State Board"]'::jsonb, 'Group', 15, 1,
 ...
 '["English", "Hindi"]'::jsonb, 4, 600, 800, 'offline', '{"morning": true, "afternoon": true, "evening": true}'::jsonb, true, 90, 4, true, 'Asia/Kolkata',
...
('b3333333-3333-3333-3333-333333333333', 'Dr. Anjali Patel', 'Chemistry professor with expertise in Organic, Inorganic, and Physical Chemistry. PhD in Chemistry from IISc Bangalore.', 
 ...
 '["Higher Secondary", "Graduate", "Professional"]'::jsonb, '["CBSE", "ICSE", "IB"]'::jsonb, 'Both', 0, 1,
 ...
 '["English", "Hindi"]'::jsonb, 3, 650, 850, 'both', '{"morning": true, "afternoon": true, "evening": true}'::jsonb, true, 92, 5, true, 'Asia/Kolkata',
...
('b5555555-5555-5555-5555-555555555555', 'Ms. Sarah Johnson', 'English Literature professor with 10 years of experience. Specialized in British Literature, Creative Writing, and Communication Skills.', 
 ...
 '["Primary", "Secondary", "Higher Secondary", "Graduate"]'::jsonb, '["CBSE", "ICSE", "IB"]'::jsonb, 'Group', 0, 1,
...
('baaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Dr. Suresh Reddy', 'Economics professor with expertise in Microeconomics, Macroeconomics, and Indian Economy. PhD from Osmania University.', 
 ...
 '["Higher Secondary", "Graduate", "Professional"]'::jsonb, '["CBSE", "ICSE", "State Board"]'::jsonb, 'Individual', 0, 1,
...
-- Step 2: Now insert into profiles table (this should work since tutor_profiles already exist)
