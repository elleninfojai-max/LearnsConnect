// Simple working auto-save utility for institution signup forms
export class WorkingAutoSave {
...
export const createWorkingPageAutoSave = (pageNumber: number): WorkingAutoSave => {
  return new WorkingAutoSave(pageNumber)
}
