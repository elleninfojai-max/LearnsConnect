...
interface CompletePageSaveIndicatorProps {
  isSaving: boolean
  lastSaved: Date | null
  hasError?: boolean
  className?: string
...
export function CompletePageSaveIndicator({ 
  isSaving, 
  lastSaved, 
  hasError = false, 
  className = '',
  showText = true,
  size = 'md'
}: CompletePageSaveIndicatorProps) {
  const getIcon = () => {
    if (hasError) {
...
export function CompactPageSaveIndicator(props: CompletePageSaveIndicatorProps) {
  return <CompletePageSaveIndicator {...props} showText={false} size="sm" />
}

// Large version for prominent display
export function LargePageSaveIndicator(props: CompletePageSaveIndicatorProps) {
  return <CompletePageSaveIndicator {...props} size="lg" />
}
