      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Connect with students and grow your teaching practice with our lead generation system
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Students Browse & Inquire</h3>
                  <p className="text-muted-foreground">Students find your profile and express interest in learning from you</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">You Receive the Lead</h3>
                  <p className="text-muted-foreground">Get student's contact details and learning requirements</p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Contact & Convert</h3>
                  <p className="text-muted-foreground">Reach out to the student and convert them into a paying customer</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Pay Only for Results</h3>
                  <p className="text-muted-foreground">You only pay when you receive a qualified lead</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Pricing Information */}
          <div className="mt-12 bg-background rounded-lg p-8 shadow-soft">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">Lead Pricing</h3>
              <p className="text-muted-foreground">Simple, transparent pricing for lead generation</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="text-center p-6 border rounded-lg">
                <div className="text-3xl font-bold text-primary mb-2">₹9</div>
                <div className="font-semibold mb-2">Tutor Leads</div>
                <div className="text-sm text-muted-foreground">Individual educators</div>
                <div className="text-xs text-muted-foreground mt-1">per lead</div>
              </div>
              <div className="text-center p-6 border rounded-lg">
                <div className="text-3xl font-bold text-green-600 mb-2">₹19</div>
                <div className="font-semibold mb-2">Institution Leads</div>
              ...
              <div className="text-center p-6 border rounded-lg">
                ...
                <div className="text-sm text-muted-foreground">For all new users</div>
                <div className="text-xs text-muted-foreground mt-1">free leads</div>
              </div>
            </div>
