-- WORKING: Delete requirements with the fixed messaging system
-- This script works with the corrected database structure
...
-- Also delete messages directly linked to these requirements
DELETE FROM messages 
WHERE requirement_id IN (
    '39bfbf7c-0d76-4bcd-8313-3cd13be0cbd9',
    'd4020e55-a9f5-407c-af37-a15c979a3d97'
