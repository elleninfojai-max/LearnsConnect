-- Create the complete institution_profiles table with all fields
-- This includes both Step 1 and Step 2 data
...
-- Policy: Allow all operations for authenticated users (you can modify this based on your needs)
CREATE POLICY "Allow all operations for authenticated users" ON institution_profiles
    FOR ALL USING (true);

-- Add comments for documentation
COMMENT ON TABLE institution_profiles IS 'Complete institution profile information including basic details, facilities, and photos';
