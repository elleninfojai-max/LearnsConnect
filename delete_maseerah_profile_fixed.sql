-- Delete Complete Profile for maseerah2003@gmail.com (FIXED)
...
-- 8. Check phone OTPs (if table exists)
SELECT 
...
-- 10. Delete course enrollments first
...
-- 13. Delete phone OTPs (if table exists)
...
-- 15. Delete institution profiles
DELETE FROM institution_profiles 
WHERE user_id = '6b0f0c18-08fe-431b-af56-c4ab23e3b25c';

-- 16. Delete institutions
...
-- 18. Delete auth user (this will also delete from auth.users)
