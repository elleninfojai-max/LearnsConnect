...
-- Removes all data except for isml.intern1@gmail.com and maseerah.research@gmail.com
...
-- 2. Get target user IDs for reference
SELECT 
...
-- First, delete notifications for non-target users
