-- Update Institution Profile with 7-Step Registration Data (FIXED)
...
SET 
    ...
    -- Photos (Step 6) - Fixed array syntax
    main_building_photo = 'https://example.com/main-building.jpg',
    classroom_photos = ARRAY['https://example.com/classroom1.jpg', 'https://example.com/classroom2.jpg'],
    laboratory_photos = ARRAY['https://example.com/lab1.jpg', 'https://example.com/lab2.jpg'],
    facilities_photos = ARRAY['https://example.com/facility1.jpg', 'https://example.com/facility2.jpg'],
    achievement_photos = ARRAY['https://example.com/achievement1.jpg', 'https://example.com/achievement2.jpg'],
    ...
    institution_photographs = ARRAY['https://example.com/photo1.jpg', 'https://example.com/photo2.jpg'],
    insurance_documents = ARRAY['https://example.com/insurance1.pdf', 'https://example.com/insurance2.pdf'],
    accreditation_certificates = ARRAY['https://example.com/naac-cert.pdf', 'https://example.com/nba-cert.pdf'],
    award_certificates = ARRAY['https://example.com/award1.pdf', 'https://example.com/award2.pdf'],
    faculty_qualification_certificates = ARRAY['https://example.com/faculty1.pdf', 'https://example.com/faculty2.pdf'],
    safety_compliance_certificates = ARRAY['https://example.com/safety1.pdf', 'https://example.com/safety2.pdf'],
