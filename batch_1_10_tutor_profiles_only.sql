-- Batch 1: First 10 Complete Dummy Tutor Profiles (TUTOR_PROFILES ONLY)
-- This script only inserts into tutor_profiles table (which worked in Step 1)
-- The profiles table requires auth.users to exist first, which we can't create via SQL
-- Copy and paste this entire script into Supabase SQL editor

-- Insert into tutor_profiles table (this worked successfully in Step 1)
