-- Update Institution Profile with 7-Step Registration Data
...
SET 
    ...
    classroom_photos = '["https://example.com/classroom1.jpg", "https://example.com/classroom2.jpg"]',
    laboratory_photos = '["https://example.com/lab1.jpg", "https://example.com/lab2.jpg"]',
    facilities_photos = '["https://example.com/facility1.jpg", "https://example.com/facility2.jpg"]',
    achievement_photos = '["https://example.com/achievement1.jpg", "https://example.com/achievement2.jpg"]',
    
    -- Course Information (Step 7)
    course_categories = '{"engineering": ["Computer Science", "Electronics", "Mechanical"], "management": ["MBA", "BBA"], "science": ["Physics", "Chemistry", "Mathematics"]}',
    course_details = '{"Computer Science": {"duration": "4 years", "fees": 50000, "seats": 60}, "MBA": {"duration": "2 years", "fees": 75000, "seats": 40}}',
    total_current_students = 500,
    average_batch_size = 30,
    student_teacher_ratio = '15:1',
    class_timings = '{"morning": "8:00 AM - 12:00 PM", "afternoon": "1:00 PM - 5:00 PM", "evening": "6:00 PM - 10:00 PM"}',
    ...
    department_heads = '{"Computer Science": "Dr. Rajesh Kumar", "Electronics": "Dr. Priya Sharma", "Mechanical": "Dr. Amit Singh"}',
    phd_holders = 10,
    post_graduates = 15,
    graduates = 5,
    ...
    board_exam_results = '{"2020": {"pass_percentage": 95, "distinction": 60}, "2021": {"pass_percentage": 97, "distinction": 65}}',
    competitive_exam_results = '{"JEE": {"qualified": 80, "top_1000": 15}, "GATE": {"qualified": 70, "top_100": 5}}',
    institution_awards = '["Best Engineering College 2020", "Excellence in Education 2021", "Innovation Award 2022"]',
    student_achievements = '["National Science Olympiad Winner", "Hackathon Champions", "Research Paper Publications"]',
    accreditations = '["NAAC A+ Grade", "NBA Accredited", "ISO 9001:2015 Certified"]',
    success_stories = '["95% placement rate", "Average package 8 LPA", "Top companies: TCS, Infosys, Wipro"]',
    
    -- Payment Information
    courses = '["Computer Science Engineering", "Electronics Engineering", "Mechanical Engineering", "MBA", "BBA"]',
    payment_modes = '["Cash", "Cheque", "Online Transfer", "Credit Card", "Debit Card"]',
    ...
    institution_photographs = '["https://example.com/photo1.jpg", "https://example.com/photo2.jpg"]',
    insurance_documents = '["https://example.com/insurance1.pdf", "https://example.com/insurance2.pdf"]',
    accreditation_certificates = '["https://example.com/naac-cert.pdf", "https://example.com/nba-cert.pdf"]',
    award_certificates = '["https://example.com/award1.pdf", "https://example.com/award2.pdf"]',
    faculty_qualification_certificates = '["https://example.com/faculty1.pdf", "https://example.com/faculty2.pdf"]',
    safety_compliance_certificates = '["https://example.com/safety1.pdf", "https://example.com/safety2.pdf"]',
